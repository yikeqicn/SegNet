...
def training(FLAGS, is_finetune=False):
  ...
  # For CamVid
#  images, labels = CamVidInputs(image_filenames, label_filenames, batch_size) #yike moved it out here
  #print(labels)
  #raise Exception('so far so good')

#  val_images, val_labels = CamVidInputs(val_image_filenames, val_label_filenames, batch_size) #yike moved it out here
